...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "8aa118f172498e", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "24424a4c0fb35e", "SMTP password")
