...
import (
	...
	"github.com/ifaisalabid1/greenlight/internal/data/validator"
...
var ErrDuplicateEmail = errors.New("error: duplicate email")
...
func ValidateUser(v *validator.Validator, user *User) {
	...
	v.Check(len(user.Name) <= 500, "name", "must not be 500 characters long")
